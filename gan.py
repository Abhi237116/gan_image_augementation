...
class GAN(torch.nn.Module):
    ...
    def train(
        self, data_loader, num_epoch, start_epoch=0, printProgress=False, updateEvery=50
    ):
        """
        ...
        for epoch in range(start_epoch, num_epoch):
            ...
            for n_batch, real_data in enumerate(
                ...
                for _ in range(self.discriminator_steps):
                    ...
                    disc_loss += (
                        self.train_discriminator(real_data, fake_data).item()
        ...
        utils.plot_loss(
            ...
            self.lst_disc_loss,
            self.lst_gen_loss,
            "./outputs/trial{}/gan{}/loss{}-{}".format(
                self.trial, self.id, start_epoch, num_epoch
            ),
        )
    ...
    def sample_images(self, epoch):
        ...
        utils.vector_to_img(
            synth_data,
            "./outputs/trial{}/gan{}/epoch{}.jpg".format(self.trial, self.id, epoch),
        )

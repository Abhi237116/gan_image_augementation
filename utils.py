...
def loadDataset(
    ...
    train_images, train_labels = loadlocal_mnist(
        images_path=image_path, labels_path=label_path
    )
    ...
    labeledDataLoader = torch.utils.data.DataLoader(
        allData, batch_size=batch_size, shuffle=True
    )
...
def get_dev_accuracy(
    ...
    test = (torch.tensor(test_images) - 128.0) / 128
